...
#define PLATFORM_ACLINT_MTIMER_FREQ 24000000
#define PLATFORM_ACLINT_MSWI_ADDR   (PLATFORM_CLINT_ADDR + \
                     CLINT_MSWI_OFFSET)
#define PLATFORM_ACLINT_MTIMER_ADDR (PLATFORM_CLINT_ADDR + \
                     CLINT_MTIMER_OFFSET)
#define PLATFORM_UART_ADDR          0x10010000
#define PLATFORM_UART_INPUT_FREQ    24000000
...
static int c910_early_init(bool cold_boot)
{
    if (cold_boot) {
        ...
        c910_regs.plic_base_addr = PLATFORM_PLIC_ADDR;//csr_read(CSR_PLIC_BASE);
